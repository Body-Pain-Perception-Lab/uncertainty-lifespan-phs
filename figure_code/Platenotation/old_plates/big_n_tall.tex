...
\draw[->] (m0-2-1) to (m0-4-4);
\draw[->] (m0-4-1) to (m0-4-4);
\draw[->] (m0-4-4) to (m0-4-6);
...
\draw[->] (m1-3-4) to (m0-4-4);
\draw[->] (m1-3-3) to (m0-4-4);
...
\draw[->] (m2-2-1) to (m2-4-4);
\draw[->] (m2-4-1) to (m2-4-4);
\draw[->] (m2-4-4) to (m2-4-6);
\draw[->] (m1-3-4) to (m2-4-4);
\draw[->] (m1-3-3) to (m2-4-4);
% Plates
\pgfsetcornersarced{\pgfpoint{5mm}{5mm}}
\node[draw=black, fit=(m0-2-1) (m2-4-6), inner sep=10mm] {};
\pgfsetcornersarced{\pgfpoint{5mm}{5mm}}
\node[draw=black, fit=(m0-4-4) (m2-4-6), inner sep=10mm] {};

\node[rotate=0, anchor=west] at (-4.0,-12.5) {s subjects};
\node[rotate=0, anchor=west] at (1.2,-12.5) {t trials};
